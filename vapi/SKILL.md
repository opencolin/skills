---
name: vapi
description: "Use when managing Vapi voice agents, assistants, calls, phone numbers, tools, webhooks, Vapi REST API operations, Vapi CLI workflows, or OpenClaw voice-agent integrations."
---
...
```bash
# list assistants
VAPI_API_KEY=... node bin/vapi-api.mjs assistants:list

# create assistant
VAPI_API_KEY=... node bin/vapi-api.mjs assistants:create \
...
VAPI_API_KEY=... node bin/vapi-api.mjs calls:create \
...
- `SKILL.md` — this file
- `bin/vapi-api.mjs` — minimal REST helper
